...
from espnet.nets.scorers.hotword_fst import HwFSTFullScorer
...
class Speech2Text:
    ...
    def __init__(
        ...
        # 3. Build hotowrd model
        if hwfst_weight!=0:
            hw_fst=HwFSTFullScorer([[4341, 123, 1732, 8],
                                    [400]],num_of_token=5000)
            scorers["hw_fst"] = hw_fst
