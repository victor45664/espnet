...
from espnet.nets.batch_beam_search_intersect import BatchBeamSearch
...
def inference(
    ...
    intersection_topk: Optional[int],
    ...
    speech2text.beam_search.intersection_topk=intersection_topk
...
def get_parser():
    ...
    parser.add_argument(
        ...
        type=int,
        default=200,
        help="Topk of the acoustic score and lm score is used to do intersection,should not be bigger than number of BPE",
    )
    parser.add_argument(
        "--assigngpu",
        type=int,
