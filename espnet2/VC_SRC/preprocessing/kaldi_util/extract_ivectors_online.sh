...
absdir=$(ppg_extractor/make_absolute.sh $dir)
...
for n in $(seq $nj); do
  ...
  ppg_extractor/create_data_link.pl $dir/ivector_online.$n.ark
done
...
ppg_extractor/get_ivector_id.sh $srcdir > $dir/final.ie.id || exit 1
