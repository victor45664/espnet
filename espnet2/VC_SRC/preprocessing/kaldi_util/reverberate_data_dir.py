...
data_lib = imp.load_source('dml', 'ppg_extractor/data_dir_manipulation_lib.py')
...
def create_reverberated_copy(input_dir,
    ...
    if not os.path.isfile(input_dir + "/reco2dur"):
        ...
        data_lib.RunKaldiCommand("ppg_extractor/get_reco2dur.sh {}".format(input_dir))
    ...
    data_lib.RunKaldiCommand("ppg_extractor/utt2spk_to_spk2utt.pl <{output_dir}/utt2spk >{output_dir}/spk2utt"
    ...
    data_lib.RunKaldiCommand("ppg_extractor/validate_data_dir.sh --no-feats --no-text {output_dir}"
                    .format(output_dir = output_dir))
