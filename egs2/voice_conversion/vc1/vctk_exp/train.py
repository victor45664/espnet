...
train_loader=infinite_seqlength_optmized_dataloader(train_dataset,mynn.hparams.batchsize,'train_dataset',num_workers=2,max_batchsize_mul_max_length=64*2000)

test_dataset=BNfeats_meltarget_spk_dataset(os.path.join(mynn.datadir,'dev'), output_per_step=mynn.hparams.n_frames_per_step)
test_loader=infinite_seqlength_optmized_dataloader(test_dataset,mynn.hparams.batchsize,num_workers=1,max_batchsize_mul_max_length=64*400)
