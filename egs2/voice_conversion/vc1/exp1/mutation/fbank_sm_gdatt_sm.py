...
#
source_scp='/home/projects/12001458/yufei/espnet/egs2/voice_conversion/vc1/dump/bdl_2_jmk_fbank/source_feats_train.scp'
target_scp='/home/projects/12001458/yufei/espnet/egs2/voice_conversion/vc1/dump/bdl_2_jmk_fbank/target_feats_train.scp'

source_scp_test='/home/projects/12001458/yufei/espnet/egs2/voice_conversion/vc1/dump/bdl_2_jmk_fbank/source_feats_test.scp'
target_scp_test='/home/projects/12001458/yufei/espnet/egs2/voice_conversion/vc1/dump/bdl_2_jmk_fbank/target_feats_test.scp'
...
hparams.batchsize=42


#hparam override

hparams.encoder_conf["linear_units"]=256
...
class LocationLayer(nn.Module):
    ...
    def forward(self, attention_weights_cat):
        ...
        processed_attention = processed_attention.transpose(1, 2)    #[1,T,attention_location_n_filters]
...
class Attention(nn.Module):
    ...
    def get_alignment_energies(self, query, processed_memory,
        ...
        PARAMS
        ------
        query: decoder output (batch, n_mel_channels * n_frames_per_step)   #这里似乎不对，应该是(B,attention_rnn_dim)
    ...
    def forward(self, attention_hidden_state, memory, processed_memory,
        ...
        alignment = self.get_alignment_energies(
            attention_hidden_state, processed_memory, attention_weights_cat)   #各个timestep的attention权重，此时还没有softmax
        ...
        return attention_context, attention_weights   #attention后的memory,和attention的权重
...
class Decoder(nn.Module):
    ...
    def initialize_decoder_states(self, memory, mask):
        ...
        self.memory = memory
        self.processed_memory = self.attention_layer.memory_layer(memory)  #处理了过后的memory
        self.mask = mask
    ...
    def forward(self, memory, decoder_inputs, memory_lengths):
        ...
        ------
        memory: Encoder outputs
        decoder_inputs: Decoder inputs for teacher forcing. i.e. mel-specs  #teacher
...
class VC_model(nn.Module):
    def __init__(self, hparams):
        ...
        self.guided_att_loss=GuidedAttentionLoss()
    ...
    def gen_gate_target(self,gate_outputs,output_length):
        with torch.no_grad():
            gate_target = gate_outputs.new_zeros(gate_outputs.size())

            max_len = torch.max(output_length).item()
            ids = torch.arange(0, max_len, device=output_length.device)
            mask = (ids+1 < output_length.unsqueeze(1)).bool()
    ...
    def forward(self, source_utts, source_utts_lengths, target_utts, target_utts_lengths):
        ...
        guided_att_loss=self.guided_att_loss(alignments,encoder_outputs_length,target_utts_lengths)
        ...
        gate_target=self.gen_gate_target(gate_outputs,target_utts_lengths)
        ...
        state["guided_att_loss"]=guided_att_loss
        loss=mel_loss+ mel_loss_final+gate_loss+5*guided_att_loss

        return loss,mel_outputs_postnet,state


    def inference(self, source_utts,source_utts_lengths):
                                                                
        encoder_outputs,_,_ = self.encoder(source_utts, source_utts_lengths)
