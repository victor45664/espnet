...
#PBS -o /home/projects/12001458/yufei/espnet/egs2/librispeech/asr1/exp/downmodel/debug/qsub.log                                
...
set -x
set -o pipefail
exp_dir=/home/projects/12001458/yufei/espnet/egs2/librispeech/asr1/exp/downmodel/unadl_exp/debug

python3 -m espnet2.bin.asr_train_ilme_unadl \
--ngpu 1 \
...
--fold_length 150 \
--output_dir $exp_dir \
--config unadl_exp/conf/adl_sgd_1gpu_0.3.yaml \
