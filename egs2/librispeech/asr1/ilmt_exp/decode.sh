...
param_set[0]="--lm_weight=0.0,0.5 --ilm_weight=0.0 --ctc_weight=0.3 --beam_size 60"
param_set[1]="--lm_weight=0.7,0.6 --ilm_weight=0.0 --ctc_weight=0.3 --beam_size 60"
param_set[2]="--lm_weight=0.3,0.4 --ilm_weight=0.0 --ctc_weight=0.3 --beam_size 60"
#param_set[2]="--lm_weight=0.7,0.8 --ilm_weight=-0.6 --ctc_weight=0.3 --beam_size 60"
# param_set[4]="--lm_weight=0.7,0.8 --ilm_weight=0.3 --ctc_weight=0.3 --beam_size 60"
# param_set[5]="--lm_weight=0.0 --ilm_weight=0.3 --ctc_weight=0.3 --beam_size 60"
#param_set[2]="--ilm_weight=-0.2 --lm_weight=0.3,0.4 --ctc_weight=0.3 --beam_size 60"
#param_set[1]="--ilm_weight=-0.7 --lm_weight=0.6,0.7 --ctc_weight=0.3 --beam_size 60"
