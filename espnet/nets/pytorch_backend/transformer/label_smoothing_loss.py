...
class LabelSmoothingLoss_unadl(nn.Module):
    """Label-smoothing loss with uniform distribution adl loss.
    ...
    def __init__(
        ...
        """Construct an LabelSmoothingLoss object."""
        super(LabelSmoothingLoss_unadl, self).__init__()
        self.criterion = criterion
        self.padding_idx = padding_idx
        self.confidence = 1.0 - smoothing
        self.smoothing = smoothing
...
class LabelSmoothingLoss_kd(nn.Module):
    ...
    def __init__(
        ...
        """Construct an LabelSmoothingLoss object."""
        super(LabelSmoothingLoss_kd, self).__init__()
        self.criterion = criterion
        self.padding_idx = padding_idx
        self.confidence = 1.0 - smoothing
        self.smoothing = smoothing
